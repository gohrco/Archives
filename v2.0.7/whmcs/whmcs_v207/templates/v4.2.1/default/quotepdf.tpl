...
foreach ($lineitems AS $item) {
    ...
    $pdf->SetXY(35,$starty);
    $pdf->MultiCell(80,5,$item["description"],1,'L','',1);

    $finishy = $pdf->GetY();

    $pdf->SetXY(20,$starty);
    $pdf->MultiCell(15,$finishy-$starty,$item["qty"],1,'C','',1);
    $pdf->SetXY(115,$starty);
    $pdf->MultiCell(25,$finishy-$starty,$item["unitprice"],1,'C','',1);
    $pdf->SetXY(140,$starty);
    $pdf->MultiCell(25,$finishy-$starty,$item["discount"],1,'C','',1);
    $pdf->SetXY(165,$starty);
    $pdf->MultiCell(25,$finishy-$starty,$item["total"],1,'C','',1);
