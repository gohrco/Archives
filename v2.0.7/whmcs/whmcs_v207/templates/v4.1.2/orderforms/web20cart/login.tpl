...
<form action="jwhmcs.php?goto=cart&task=jlogin" method="post">
  {if $incorrect}
  ...
  <p align="center">
    <input type="submit" value="{$LANG.loginbutton}" />
  </p>
</form>
<p align="center"><strong>{$LANG.loginforgotten}</strong> <a href="passwordreminder.php" target="_blank">{$LANG.loginforgotteninstructions}</a>.</p>
<div class="drop_poweredby">